...
public class ProcessProgressAsynctaskActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_process_progress_asynctask);
        app();
    }
