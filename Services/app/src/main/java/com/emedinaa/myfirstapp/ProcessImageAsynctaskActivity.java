...
import com.emedinaa.myfirstapp.asynctask.ImageTask;

import java.net.URL;

public class ProcessImageAsynctaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_process_image_asynctask);
    ...
    private void downloadImage() {
        ...
        try{
            ...
            URL url = new URL("https://lh3.googleusercontent.com/--L0Km39l5J8/URquXHGcdNI/AAAAAAAAAbs/3ZrSJNrSomQ/s1024/Antelope%252520Butte.jpg");
