...
package com.emedinaa.myfirstapp.location;
...
import com.emedinaa.myfirstapp.MainActivity;
...
class Utils {
    ...
    static void sendNotification(Context context, String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(context, MainLocationActivity.class);
